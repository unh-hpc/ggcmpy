    ...
    def plot(
        ...
        **kwargs,
        ...
        if isinstance(self._obj, xr.Dataset):
            msg = "Call .ggcm.plot() on a DataArray."
            raise TypeError(msg)
...
def cpcp(iof, hemisphere: str = "north") -> xr.DataArray:
...
def jh(iof, hemisphere: str = "north") -> xr.DataArray:
...
def _al_index_one_time(iof: xr.Dataset) -> xr.Dataset:
    ...
    # Calculate the values for all stations once
    vals = [
