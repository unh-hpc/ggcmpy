...
In theory, the ground magnetic perturbation in the $i$-direction at $\mathbf{r}$
due to a variation of a current density in the $j$-direction at $\mathbf{r}'$
is,
...
Integrating over space, the total ground magnetic perturbation at $\mathbf{r}$
is then,
